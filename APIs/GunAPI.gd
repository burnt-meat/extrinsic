...
func create_weapon(p_name: String, damage: float, cooldown: float, mag_size: int, reload_time: float, full_auto: bool, effects: Array[Resource], scene_path: String) -> int:
	var holder := _get_weapon_holder()
